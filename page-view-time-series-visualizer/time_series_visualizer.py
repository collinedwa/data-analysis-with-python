...
def draw_line_plot():
    ...
    sns.lineplot(data=df_line, palette='Set1', legend=False)
    ax.set_xlabel('Date')
...
def draw_bar_plot():
    ...
    df_bar = pd.concat([prev_months, df_bar])


    # Draw bar plot
    fig, ax = plt.subplots(figsize=(7.57, 6.65), dpi=200)
    barplot = sns.barplot(data=df_bar, x='Years', y='Average Page Views', hue='Months', palette='tab10')
    ax.set_xlabel('Years')
...
def draw_box_plot():
    ...
    fig, axes = plt.subplots(1, 2, figsize=(14.4, 5.4), dpi=200)
